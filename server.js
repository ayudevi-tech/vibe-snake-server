...
const WORDS = [
  {t:'SHIP IT',y:'power',c:'#1D9E75',p:15,e:'Speed boost! Shipping mode on.',i:'🚀',ms:2,mv:'wander'},
  {t:'PIPELINE',y:'bonus',c:'#7F77DD',p:20,e:'Score x2 for 8 moves!',i:'💰',ms:3,mv:'flee'},
  {t:'OUTBOUND',y:'bonus',c:'#7F77DD',p:25,e:'Outbound energy! Big points.',i:'📤',ms:3,mv:'flee'},
  {t:'GTM',y:'bonus',c:'#7F77DD',p:30,e:'Go-to-market bonus!',i:'🎯',ms:4,mv:'flee'},
  {t:'DEPLOY',y:'power',c:'#1D9E75',p:12,e:'Deploy! +3 length.',i:'✅',ms:2,mv:'wander'},
  {t:'SPRINT',y:'power',c:'#1D9E75',p:18,e:'Sprint! Faster.',i:'⚡',ms:4,mv:'bounce'},
  {t:'LEADS',y:'bonus',c:'#7F77DD',p:25,e:'Leads incoming!',i:'💼',ms:3,mv:'flee'},
  {t:'DEMO',y:'bonus',c:'#7F77DD',p:35,e:'Demo day! Score x2.',i:'🎤',ms:3,mv:'flee'},
  {t:'CLOSE',y:'bonus',c:'#7F77DD',p:40,e:'Deal closed! Jackpot.',i:'🏆',ms:5,mv:'flee'},
  {t:'VIRAL',y:'bonus',c:'#7F77DD',p:45,e:'Gone viral! x3 score!',i:'📈',ms:6,mv:'flee'},
  {t:'RAISE',y:'bonus',c:'#7F77DD',p:50,e:'Series raise! Massive bonus.',i:'💎',ms:7,mv:'flee'},
  {t:'OKR',y:'danger',c:'#D85A30',p:5,e:'OKR season... stunned!',i:'😵',ms:3,mv:'hunt'},
  {t:'BLOCKERS',y:'danger',c:'#D85A30',p:5,e:'Blockers! Wall appeared.',i:'🧱',ms:2,mv:'wander'},
  {t:'REORG',y:'danger',c:'#D85A30',p:8,e:'Reorg! Direction flipped.',i:'🔀',ms:4,mv:'hunt'},
  ...
  {t:'BUG',y:'danger',c:'#D85A30',p:3,e:'Bug in prod! Slowed.',i:'🐛',ms:4,mv:'hunt'},
  {t:'FIRE DRILL',y:'danger',c:'#D85A30',p:2,e:'Fire drill! Everyone stunned.',i:'🚨',ms:5,mv:'hunt'},
  {t:'CHAOS',y:'chaos',c:'#EF9F27',p:20,e:'Pure chaos! All speed up.',i:'🌪️',ms:6,mv:'erratic'},
  {t:'PIVOT',y:'chaos',c:'#EF9F27',p:15,e:'Direction surprise!',i:'🔄',ms:5,mv:'erratic'},
  {t:'YOLO',y:'chaos',c:'#EF9F27',p:25,e:'Random effect!',i:'🎲',ms:7,mv:'erratic'},
  {t:'ALL IN',y:'chaos',c:'#EF9F27',p:20,e:'Double or nothing!',i:'🃏',ms:4,mv:'erratic'},
  {t:'SCOPE CREEP',y:'danger',c:'#D85A30',p:4,e:'Scope creep! Shrunk.',i:'😬',ms:3,mv:'hunt'},
  {t:'UPSELL',y:'bonus',c:'#7F77DD',p:30,e:'Upsell! Score up.',i:'⬆️',ms:4,mv:'flee'},
  {t:'SYNC',y:'power',c:'#1D9E75',p:10,e:'Sync up! +3 length.',i:'🔄',ms:2,mv:'wander'},
  {t:'FEEDBACK',y:'power',c:'#1D9E75',p:12,e:'Feedback loop! +3 length.',i:'🔁',ms:2,mv:'wander'},
  {t:'ASYNC',y:'power',c:'#1D9E75',p:10,e:'Async! Smoother speed.',i:'😌',ms:2,mv:'wander'},
];
